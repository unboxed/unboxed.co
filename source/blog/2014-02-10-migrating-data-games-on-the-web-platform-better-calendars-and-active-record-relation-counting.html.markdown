...
## Migrating live data is a pain, use this gem to make it simpler - [Tom Russell](/people/tom-russell)
...
## How many relations could an active record model have if an active record model could chuck wood? - [Jolyon Pawlyn](/people/jolyon-pawlyn)
