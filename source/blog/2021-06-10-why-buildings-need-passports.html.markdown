...
Of course, in addition to the geographical space occupied by a building and whether its size and use is appropriate to its location, information about its materials and methods of construction are vitally important. As we saw with the tragic events at Grenfell Tower, developers and builders should be held accountable for their decisions and work - as planning specialist Jack Ricketts puts it, “Excel kills”.
